...
class _CurvedDrawerState extends State<CurvedDrawer>
  ...
  void initState() {
    super.initState();
    _items = widget.items.map<DrawerNavItem>((item) {
      ...
      child: Stack(
        ...
        children: <Widget>[
          Positioned(
            ...
            child: Center(
              child: Transform.translate(
                  offset: Offset(
                    _isEnd * (1 - _buttonHide) * (75 + (widget.width * 0.2)),
                    0,
                  ),
                  child: _icon),
            ),
          ...
          Positioned(
            ...
            width: widget.width,
            child: CustomPaint(
              painter: DrawerCustomPainter(_pos!, _length!, widget.color,
                  Directionality.of(context), widget.width, widget.isEndDrawer),
              child: Container(width: widget.width, height: size.height),
            ),
          ),
          Positioned(
            top: 0,
